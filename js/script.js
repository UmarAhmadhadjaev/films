...
let elSelect = document.querySelector("#types-select");
...
function renderFilms(arr, list) {
  ...
  for (let film of arr) {
    ...
    elDeleteBtn.dataset.filmId = film.id;
    ...
    // console.log(film);
    elLi.append(elImg, elTitle, elText, elSubList, elDeleteBtn);
